...
import de.tum.i13.server.nio.ChangeRequest;
...
public class SimpleEcsServer{
    ...
    public SimpleEcsServer(CommandProcessor cmdProcessor) {
    ...
    private void read(SelectionKey key) throws IOException {
        ...
        //logger.info("#tempdata:" + new String(dataCopy, Constants.TELNET_ENCODING));
    ...
    private void handleRequest(SelectionKey selectionKey, String request) {
        try {
            ...
            send(selectionKey, (res == null) ? null : res.getBytes(Constants.TELNET_ENCODING));
