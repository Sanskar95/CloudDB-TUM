...
public class Config {
    ...
    @CommandLine.Option(names = "-b", description = "bootstrap broker where clients and other brokers connect first to retrieve configuration, port and ip, e.g., 192.168.1.1:5153", defaultValue = "127.0.0.1:5153")
    ...
    @CommandLine.Option(names = "-ll", description = "Logfile", defaultValue = "INFO")
    ...
    @CommandLine.Option(names = "-th", description = "number of eventbulisher worker Threads", defaultValue = "1")
    public int eventPubThreads;
